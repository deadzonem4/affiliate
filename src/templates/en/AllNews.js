  ...
  render() {
    ...
    const news = this.props.api.map((filters, index) =>
      <div className="news-box-content" key={index}>
        <Link className="all-news-img" to={{pathname: `/en/news${index + 1}`}}>
        ...
        <div className="all-news-content">
          ...
          <div className="all-news-title">
            <h4>{filters.title_en}</h4>
          </div>
          <div className="all-news-text">
            <p>{filters.short_description_en}</p>
          </div>
          <Link className="all-news-link"  to={{pathname: `/en/news${index + 1}`}}>
          {this.props.read}
          </Link>
        </div>
      </div>
