            ...
            <div className="row">
              <article className="single-article-box col-md-9">
                ...
                <div className="single-article-about">
                  <h4>За Winbet</h4>
                  <p>Вече близо десетилетие в концепцията за успех на верига казина WINBET е заложено непрекъснатото усъвършенстване на продуктите и услугите, които предлагаме. Модерни, уютни, с игрални автомати от най-добрите производители в света, залите ни предлагат обслужване на най-високо ниво и многобройни бонус игри, разработени според желанията на клиента. Eкипът на WINBET гарантира на своите гости отлично обслужване по време на техния престой. Веднъж посетили казиното, клиентите остават наши приятели и се връщат постоянно. Целта ни е не само да удовлетворим потребностите им, но и далеч да надминем очакванията им. Веригата WINBET расте и се развива сред първите, благодарение на това, че се вслушваме във вашите персонални нужди и предпочитания.
                  </p>
                </div>
              </article>
